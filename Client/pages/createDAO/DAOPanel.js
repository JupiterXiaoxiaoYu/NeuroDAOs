...
function layersToGraph(arrLayers, coloredLayer, coloredNode) {
...
export class ModelPanel extends Component {
    ...
    onClickNodeFunc = (e) => {
        ...
        this.props.appState.doSelectNode(SELECTED_NODE)
    }
    ...
    render() {
        ...
        let g = layersToGraph(layers, this.props.appState.coloredLayer, this.props.appState.coloredNode);
